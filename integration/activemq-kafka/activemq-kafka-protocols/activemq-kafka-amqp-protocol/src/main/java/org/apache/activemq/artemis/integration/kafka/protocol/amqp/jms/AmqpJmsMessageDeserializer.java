...
public class AmqpJmsMessageDeserializer implements Deserializer<Message> {
   ...
   private final ProtonMessageDeserializer messageDeserializer = new ProtonMessageDeserializer();
   ...
   public Message deserialize(String s, byte[] bytes) {
      org.apache.qpid.proton.message.Message protonMessage = messageDeserializer.deserialize(s, bytes);
      try {
         Message jmsMessage = JmsProtonMessageConverter.toJmsMessage(protonMessage);
