...
public final class JmsMessageTransformation {
    ...
    */
   public static JmsDestination transformDestination(Destination destination) throws JMSException {
   ...
   public static JmsMessage transformMessage(Message message) throws JMSException {
      ...
      copyProperties(message, jmsMessage);
    ...
    */
   public static void copyProperties(Message source, JmsMessage target) throws JMSException {
   ...
   private static long getForeignMessageDeliveryTime(Message foreignMessage) throws JMSException {
      ...
      try {
         ...
         if (!Modifier.isAbstract(method.getModifiers())) {
            return (long) method.invoke(foreignMessage);
         }
