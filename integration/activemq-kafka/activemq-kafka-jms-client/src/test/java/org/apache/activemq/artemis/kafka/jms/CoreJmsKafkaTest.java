...
import org.apache.activemq.artemis.kafka.jms.protocol.core.CoreJmsKafkaConnectionFactory;
import org.junit.After;
import org.junit.Before;
import org.junit.Rule;


public class CoreJmsKafkaTest {
   ...
   public void before() throws IOException, InterruptedException, JMSException {
      ...
      connectionFactory = new CoreJmsKafkaConnectionFactory("kafka://localhost:" + kafkaRule.helper().kafkaPort());
   }
