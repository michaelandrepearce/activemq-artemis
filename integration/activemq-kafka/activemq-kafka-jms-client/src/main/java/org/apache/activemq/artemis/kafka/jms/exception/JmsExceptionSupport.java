...
public final class JmsExceptionSupport {
   ...
   public static JMSException toJMSException(Exception source) {
      JMSException result = null;
      ...
      } else if (source instanceof java.io.EOFException) {
         result = new MessageEOFException(source.getMessage());
