...
public class KafkaJMSContext implements JMSContext {
   ...
   public JMSConsumer createConsumer(Destination destination) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createConsumer(destination));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createConsumer(Destination destination, String messageSelector) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createConsumer(destination, messageSelector));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createConsumer(Destination destination, String messageSelector, boolean noLocal) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createConsumer(destination, messageSelector, noLocal));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createDurableConsumer(Topic topic, String name) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createDurableConsumer(topic, name));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createDurableConsumer(Topic topic, String name, String messageSelector, boolean noLocal) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createDurableConsumer(topic, name, messageSelector, noLocal));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createSharedDurableConsumer(Topic topic, String name) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createSharedDurableConsumer(topic, name));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createSharedDurableConsumer(Topic topic, String name, String messageSelector) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createSharedDurableConsumer(topic, name, messageSelector));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createSharedConsumer(Topic topic, String sharedSubscriptionName) {
      checkSession();
      try {
         KafkaJMSConsumer consumer = new KafkaJMSConsumer(this, session.createSharedConsumer(topic, sharedSubscriptionName));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
   ...
   public JMSConsumer createSharedConsumer(Topic topic, String sharedSubscriptionName, String messageSelector) {
      checkSession();
      try {
         KafkaJMSConsumer consumer =
            new KafkaJMSConsumer(this, session.createSharedConsumer(topic, sharedSubscriptionName, messageSelector));
         checkAutoStart();
         return consumer;
      } catch (JMSException e) {
         throw JmsExceptionSupport.convertToRuntimeException(e);
