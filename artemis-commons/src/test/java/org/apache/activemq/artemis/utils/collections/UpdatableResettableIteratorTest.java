...
public class UpdatableResettableIteratorTest {
   ...
   public void testUnderlyingIterator() {
      ...
      UpdatableResettableIterator<Integer> iterator = new UpdatableResettableIterator(ArrayResettableIterator.iterator(arrayList));
      for (int i = 0; i < 1000; i++) {
