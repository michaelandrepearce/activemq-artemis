...
public class ParameterisedAddress {
   ...
   public ParameterisedAddress(SimpleString address, QueueParameters queueParameters) {
      this.address = address;
      this.queueParameters = queueParameters;
   }

   public ParameterisedAddress(String address, QueueParameters queueParameters) {
      this(SimpleString.toSimpleString(address), queueParameters);
   }
      ...
      if (index == -1) {
         ...
         for (String param : parameterPairs) {
            ...
            if (keyValue.length != 2) {
               ...
               queueParameters.set(keyValue[0], keyValue[1]);
            }
         }
         this.queueParameters = queueParameters;
      }
   ...
   public boolean isParameterised() {
      return this.queueParameters != null;
   }
