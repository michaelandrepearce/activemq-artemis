...
public class UpdatableResettableIterator<E> implements ResettableIterator<E> {

   private final AtomicReferenceFieldUpdater<UpdatableResettableIterator, ResettableIterator> changedIteratorFieldUpdater =  AtomicReferenceFieldUpdater.newUpdater(UpdatableResettableIterator.class, ResettableIterator.class, "changedIterator");
   private volatile ResettableIterator<E> changedIterator;
   private ResettableIterator<E> currentIterator;

   public UpdatableResettableIterator(ResettableIterator<E> iterator) {
   ...
   public void update(ResettableIterator<E> iterator) {
      changedIteratorFieldUpdater.set(this, iterator);
   }
   ...
   @Override
   public void reset() {
      ResettableIterator<E> changedIterator = this.changedIterator;
