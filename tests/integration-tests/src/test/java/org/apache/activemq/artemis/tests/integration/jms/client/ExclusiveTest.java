...
public class ExclusiveTest extends JMSTestBase {
   ...
   @Test
   public void testExclusiveSettingUsingAddressQueueParameters() throws Exception {
      ConnectionFactory fact = getCF();
      Connection connection = fact.createConnection();
      ...
      try {
         ...
         assertTrue(a.getQueueParameters().getExclusive());
   ...
   @Test
   public void testExclusiveConsumerFailover() throws Exception {
      ConnectionFactory fact = getCF();
      Connection connection = fact.createConnection();
