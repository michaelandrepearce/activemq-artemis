...
import org.apache.activemq.artemis.core.server.transformer.HeaderTransformer;
...
public class BridgeTest extends ActiveMQTestBase {
   ...
   public void testWithTransformerProperties() throws Exception {
      ...
      TransformerConfiguration transformerConfiguration = new TransformerConfiguration().setClassName(HeaderTransformer.class.getName());
