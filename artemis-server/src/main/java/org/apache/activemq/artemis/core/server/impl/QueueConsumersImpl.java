...
import org.apache.activemq.artemis.utils.collections.UpdatableResettableIterator;
...
public class QueueConsumersImpl<T extends PriorityAware> implements QueueConsumers<T> {
   ...
   private UpdatableResettableIterator<T> iterator = new UpdatableResettableIterator<>(consumers.resettableIterator());
