      ...
      try {
         if (clientConsumer == null) {
            synchronized (this) {
               ...
               this.clientSession = clientSessionFactory.createSession(federation.getFederationUser(), federation.getFederationPassword(), false, true, true, clientSessionFactory.getServerLocator().isPreAcknowledge(), clientSessionFactory.getServerLocator().getAckBatchSize());
               this.clientSession.addFailureListener(this);
               this.clientSession.addMetaData(FEDERATION_NAME, federation.getName());
