...
public class FederatedAddressConsumerKey implements FederatedConsumerKey {
   ...
   FederatedAddressConsumerKey(SimpleString connectionName, SimpleString address, RoutingType routingType, SimpleString queueNameFormat, SimpleString queueFilterString) {
